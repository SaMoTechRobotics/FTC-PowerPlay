...
public class AlignDataParams {
    ...
    public static int MinimumDataAmount = 8; //how long the robot has to be losing the pole to check if it is still losing the pole

    public static double LosingPoleMargin = 2; //if the robot is losing the pole check
