...
public class AutoLeftPro extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence firstTraj = drive.trajectorySequenceBuilder(drive.getPoseEstimate())
                ...
                .splineToLinearHeading(new Pose2d(SIDE * 34, -60, Math.toRadians(270)), Math.toRadians(90),
                ...
                .splineTo(new Vector2d(SIDE * 34, -46), Math.toRadians(90),
                ...
                .splineTo(new Vector2d(SIDE * 28, -12), Math.toRadians(FINAL_ROT + 180),
