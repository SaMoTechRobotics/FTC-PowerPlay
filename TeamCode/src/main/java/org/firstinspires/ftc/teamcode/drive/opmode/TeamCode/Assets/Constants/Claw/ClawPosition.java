...
public class ClawPosition {
     ...
     */
    public static double Open = 95;
    public static double PickupOpen = 70; //old claw: 86
    public static double Close = 40; //old claw: 70

    public static double ConeDistance = 3;
