package org.firstinspires.ftc.teamcode.drive.opmode.TeamCode.Auto.Sad;
...
@Config
@Autonomous(name = "AutoLeftSad", group = "AutoPro")
public class AutoLeftSad extends LinearOpMode {
...
//    public static double SlideSafetyMargin = 0.5;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        telemetry.addLine("1 + 2 Cones on Mid Pole");
        telemetry.update();
...
//            if (count == ConesToScore) break; //If all cones have been scored, break out of loop
            ...
            Slide.setHeight(SlideHeight.MidPole, SlideSpeed.Max); //Sets slide to max height
