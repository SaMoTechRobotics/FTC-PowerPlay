...
public class AutoAlignManager {
     ...
     */
    public static boolean smartAlign(SampleMecanumDrive drive, DistanceSensor leftSensor, DistanceSensor rightSensor, Chassis.PoleAlign alignDrive, Chassis.PoleAlign alignStrafe) {
